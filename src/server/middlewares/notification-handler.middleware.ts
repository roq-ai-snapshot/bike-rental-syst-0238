...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'rental.create': {
    ...
    key: 'bike-rented',
    tenantPath: ['organization', 'bike', 'rental'],
    userPath: [],
  },
  'rental.update': {
    roles: ['business-owner', 'team-member'],
...
const tenantRoles: string[] = ['business-owner', 'team-member', 'maintenance-staff', 'customer-service-representative'];
