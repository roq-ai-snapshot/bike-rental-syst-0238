...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'team-member', 'maintenance-staff', 'customer-service-representative'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Bikes', path: '/bikes', entity: 'bike', service: AccessServiceEnum.PROJECT, icon: FiActivity },
